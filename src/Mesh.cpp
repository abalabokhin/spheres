...
void MeshSetup(GLuint program, const mat4 & model) 
{
	static GLint modelLocation = glGetUniformLocation(program, "transform.model");
	glUniformMatrix4fv(modelLocation, 1, GL_TRUE, model.m);
}